...
function printToChat(data) {
    ...
    <div class="flex gap-3 my-4 text-gray-600 text-sm flex-1 justify-end">
                <p class="leading-relaxed text-right"><span class="block font-bold text-gray-400">(${data.user}) You </span><span class="text-gray-200">${messageReplaceRoomCodes}</span>
...
<div class="flex gap-3 my-4 text-gray-600 text-sm flex-1"><span
                ...
                <p class="leading-relaxed"><span class="block font-bold text-gray-400">${data.user} </span><span class="text-gray-200">${messageReplaceRoomCodes}</span>
                    <span class="block text-[8pt] text-gray-400 mt-2">${data.date}</span></p>
            </div>
`
    }
