    ...
    allData.map((item, index) => {
        tableContent.row.add([
            ...
            `<div class="flex gap-2">
                            <button onclick="blockAction('${item.ip}','permanent')" type="button" class="btn btn-danger btn-sm text-white">
                              Permanent Block
                            </button>
                            <button onclick="blockAction('${item.ip}', 'temporary')" type="button" class="btn btn-warning btn-sm">
                              Temporary Block
                            </button>
                            <button onclick="blockAction('${item.ip}','remove')" type="button" class="btn btn-success btn-sm text-white">
                              Remove Block
                            </button>
                          </div>
            `
...
async function blockAction(userIp, actionValue) {
