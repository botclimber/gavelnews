    ...
    news_div.innerHTML += /* html */
      `<div id="${r.new_id}" class="mb-6 lg:mb-0">
                <div>
                  ...
                  <button title="Open this new chat" onclick="readOnlyChat('${r.new_id}', '${r.new_title}')" class="bg-[#2c2c2c] hover:bg-[#7b7575] text-[8pt] text-white font-bold py-1 px-2 rounded inline-flex items-center">
