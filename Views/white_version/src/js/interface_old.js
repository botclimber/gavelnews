    ...
    news_div.innerHTML += /* html */
      `<div class="mb-6 lg:mb-0">
                <div>
                  ...
                  <button title="Open this new chat" onclick="readOnlyChat()" class="bg-[#983e16] hover:bg-[#b97a5f] text-[8pt] text-white font-bold py-1 px-2 rounded inline-flex items-center">
